...
```powershell
msbuild .\Potato.Study.BoostLog\Potato.Study.BoostLog.vcxproj /p:Configuration=Debug /p:Platform=x64
```
...
학습 내용을 phase 단위로 정리한 문서는 [AIReport/README.md](D:/Potato.Study/Potato.Study.BoostLog/AIReport/README.md:1) 에서 시작한다.
